...
function Footer() {
  return (
    <div className="w-full flex flex-col text-center lg:items-center lg:max-w-[1000px] mx-auto  py-10 md:py-8 justify-center">
      <div className="flex py-4  items-center max-w-[350px] mx-auto w-full justify-evenly">
      ...
      <div className="grid grid-cols-1 md:flex gap-[1rem] justify-center py-6 lg:pt-0 lg:pb-4 px-4 text-left">
        {navLinks.map(link => (
          <NavLink
            ...
            href={link.href}
            text={link.text}
            classNames="font-semibold py-2 lg:py-0 text-center text-base md:text-[18px] hover:text-AP-blue-200"
            footer
          />
        ))}
      </div>
